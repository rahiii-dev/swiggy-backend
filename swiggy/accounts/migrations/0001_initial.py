    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_no', models.CharField(max_length=10, null=True, verbose_name='Phone Number')),
                ('full_name', models.CharField(blank=True, max_length=50, null=True, verbose_name='Full Name')),
                ('user_type', models.PositiveSmallIntegerField(choices=[(1, 'admin'), (2, 'user'), (3, 'restaurant'), (4, 'delivery')], default=2)),
